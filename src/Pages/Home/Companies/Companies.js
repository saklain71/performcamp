    ...
    return (
        <div class="bg-base-100 max-h-lg py-10">
            ...
            <div className='grid grid-cols-6 px-20 justify-center items-center'>
                <img src={img1} style={{width: '170px'}} alt="" />
                <img src={img2} style={{width: '170px'}} alt="" />
                <img src={img3} style={{width: '170px'}} alt="" />
                <img src={img4} style={{width: '170px'}} alt="" />
                <img src={img5} style={{width: '170px'}} alt="" />
                <img src={img6} style={{width: '170px'}} alt="" />
            </div>
        </div>
    );
};
