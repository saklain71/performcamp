...
const StoryLeadership = () => {
    return (
        <div className='container'>
            ...
            <h3 className='font-bold lg:text-4xl text-2xl text-center pt-7 pb-3'>We’re shaking up the world <br />
            ...
            <h4 className='bg-green-300 lg:p-10 p-5 text-center font-semibold lg:text-4xl text-2xl'>Meet Our Leadership Team</h4>
