    ...
    <div className=''>
      ...
      <div className='text-center my-12'>
        ...
        <div class="overflow-x-auto my-4">
          ...
          <button class="btn btn-error hover:bg-teal-600 my-2 mx-6">Performance Management</button>
          <button class="btn btn-error hover:bg-teal-600 my-2 mx-6">Employee Reviews</button>
          <button class="btn btn-error hover:bg-teal-600 my-2 mx-6">Continuous Feedback</button>
          <button class="btn btn-error hover:bg-teal-600 my-2 mx-6">Goal Management</button>
        </div>
